...
<head>
    ...
    <title>PTE Preparation - Practice Answer Short Question</title>
...
<body>
    ...
    <div class="gill">
        <div class="header">
            <p> PTE Answer Short Question Practice Questions - <?php echo $_SESSION['name'];?></p>
            <div id="cover">
	...
	<div class="container">
        ...
        <div id="footer" class="bottom1"><a href="practiceAnswerShortQuestion.html.php?page=<?php echo $_GET['page']+1; ?>">Next</a></div>
    </div>
    </div>
  <script>
      var time = 30;
...
<script>
	...
	var audiosource = "serveruploads/questions/answershortquestion/<?php echo trim($row['shofile']); ?>";	//enter audiosource here
...
//        setTimeout(strtrecording,audiodurt+1000);
//    }
        ...
        function upload(blob){    
            ...
            xhr('myphpuploaders/shortanswer11uploader.php', formData, function (fName) {
