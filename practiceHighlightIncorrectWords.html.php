...
$url = "practiceHighlightIncorrectWords.html.php?page=".$next;
...
<head>
    ...
    <title>PTE Preparation - Practice Highlight Incorrect Words</title>
...
<body>
    ...
    <div class="container-fluid">
        <div class="gill">
        <div class="header">
            <p> PTE Highlight Incorrect Words Practice Questions - <?php echo $_SESSION['name'];?></p>
            <div id="cover">
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-11">
                <div class="content"><?php echo trim($row['lhicontent']);?></div>
...
$(document).ready(function(){
  ...
  var audiosource = "serveruploads/questions/lhighlightincorrectword/<?php echo trim($row['lhifile']); ?>";		//	Audio source
