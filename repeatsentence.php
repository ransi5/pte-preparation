...
if (isset($_POST['time'])) {
    if ($_POST['time'] < 0) {
        ...
        try {
            header('location: repeatsentence2.php?x=' . $_POST['time'] . '&y=' . $_POST['ftime']);       
            exit();
        } catch (PDOException $e) {
            echo '<br> error updating database: ' . $e->getMessage();
            exit();
...
<head>
    ...
    <title>PTE Practice Test - Repeat Sentence Question 1</title>
...
//    }
        ...
        function upload(blob){    
            ...
            xhr('myphpuploaders/repeatsentenceuploader.php', formData, function (fName) {
