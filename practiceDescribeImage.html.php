...
<head>
    ...
    <title>PTE Preparation - Practice Describe Image</title>
...
<body>
    ...
    <div class="gill">
        <div class="header">
            <p> PTE Describe Image Practice Questions - <?php echo $_SESSION['name'];?></p>
            <div id="cover">
	...
	<pre id="log"></pre>
        ...
        <div id="footer" class="bottom"><a href="practiceDescribeImage.html.php?page=<?php echo $_GET['page']+1; ?>">Next</a></div>
    </div>
    </div>
  <script>
    var time = 66;
...
<script>
	var prepare_time = 26;			//enter preparetime here
	var recording_time = 40;			//enter recordingtime here
	var numofrows = 1;				//enter when there are mupltiple questions
	var imagesource = "serveruploads/images/imagespeak/<?php echo trim($row['desfile']);?>";	//enter image source here
...
function successCallback(stream){
    setTimeout(strtrecording,prepare_time*1000+2200);    
        ...
        function upload(blob){    
            ...
            xhr('myphpuploaders/imagespeak11uploader.php', formData, function (fName) {
