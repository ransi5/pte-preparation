...
<div class="container">
    <div class="bbox">
        ...
        <div class="confbox">
            <h4>PTE preparation Diamond Course - <span class="curr spchar"></span> <span class="price spchar"></span></h4>
            <p>You get</p>
            ...
            complete access to PTE strategy & tips on our blog - Email support for upto 84 queries - option to add coaching hours 
            - FREE upto 1 hour of personal coaching - Free feedback for 1 practice test</p>
        ...
        <div class="buttons">
            <form action="https://www.2checkout.com/checkout/purchase" method="post">
                ...
                <input type='hidden' name='li_0_name' value='Diamond Course' >
...
$(document).ready(function() {
    $.getJSON("https://freegeoip.net/json/", function (data) {
        ...
        if (country == "India") {
            ...
            $('input[name="li_0_price"]').val('2470.00')
        } else if (country == "Bangladesh") {
            $('.curr').html('USD')
            $('.price').text('39.00')
            $('input[name="currency_code"]').val('USD')
            $('input[name="li_0_price"]').val('39.00')
            ...
            $('.price').text('50')
            $('input[name="currency_code"]').val('USD')
            $('input[name="li_0_price"]').val('50.00')
        } else {
            $('.curr').html('USD')
            $('.price').text('50')
            $('input[name="currency_code"]').val('USD')
