...
session_start();
include 'connect.php';
$sth = $db->prepare("SELECT * FROM retelllecture");
$sth->execute();
$numofrows=$sth->rowCount();

$audioprestring="serveruploads/questions/retelllecture/";
$imageprestring="serveruploads/images/retelllecture/";
...
<body>
	...
	<div class="container">
		<div class="row">
   			<p class="text-justify" ><strong><i>You will hear a lecture. After listening to the lecture, in 10 seconds, please speak into the microphone and retell what you have just heard from the lecture in your own words. You will have 40 seconds to give your response.</i></strong></p>
        </div>
		<br>
		<br>
		<br>
		...
		<div class="row">
            <button id="next" class="btn btn-primary pull-right" onclick="main()" style="width:90px">Next</button>
        </div>
		<div id="row">
 ...
 //   button.nextElementSibling.disabled = false;
  ...
  <script src="mylibs/retelllecturerecordmp3.js"></script>
</body>
</html>