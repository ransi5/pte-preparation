...
$url = "practiceEssay.html.php?page=".$next;
...
<head>
    ...
    <title>PTE Preparation - Practice Write Essay</title>
...
<body>
    ...
    <div class="gill">
        <div class="header">
            <p> PTE Write Essay Practice Questions - <?php echo $_SESSION['name'];?></p>
            <div id="cover">
        ...
        <div class="container">
            ...
            <div class="content"><?php echo trim($row['esscontent']);?></div>
            <br>
            <br>
            <div class="row">
                <div class="col-md-11">
