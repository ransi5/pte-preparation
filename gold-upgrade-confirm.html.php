...
<div class="container">
    <div class="bbox">
        ...
        <div class="confbox">
            <h4>PTE preparation Gold Course upgrade - <span class="curr spchar"></span> <span class="price spchar"></span></h4>
            <p>You get</p>
            ...
            complete access to PTE strategy & tips on our blog - option to upgrade to Diamond course</p>
        ...
        <div class="buttons">
            <form action="https://www.2checkout.com/checkout/purchase" method="post">
                ...
                <input type='hidden' name='li_0_name' value='Gold Course Upgrade' >
            ...
            - answer key with model answers - in-depth practice test result & analysis - Complete access to G-Analytics - 
            complete access to PTE strategy & tips on our blog - option to upgrade to Diamond course' >
...
$(document).ready(function() {
    $.getJSON("https://freegeoip.net/json/", function (data) {
        ...
        if (country == "India") {
            ...
            $('input[name="li_0_price"]').val('910.00')
        } else if (country == "Bangladesh") {
            $('.curr').html('USD')
            $('.price').text('13.00')
            $('input[name="currency_code"]').val('USD')
            $('input[name="li_0_price"]').val('13.00')
            ...
            $('.price').text('14')
            $('input[name="currency_code"]').val('USD')
            $('input[name="li_0_price"]').val('14.00')
        } else {
            $('.curr').html('USD')
            $('.price').text('14')
            $('input[name="currency_code"]').val('USD')
