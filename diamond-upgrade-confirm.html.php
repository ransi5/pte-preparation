...
<div class="container">
    <div class="bbox">
        ...
        <div class="confbox">
            ...
            complete access to PTE strategy & tips on our blog - option to add coaching hours - Email support for upto 84 queries 
...
$(document).ready(function() {
    $.getJSON("https://freegeoip.net/json/", function (data) {
        ...
        if (country == "India") {
            ...
            $('input[name="li_0_price"]').val('990.00')
        } else if (country == "Bangladesh") {
            $('.curr').html('USD')
            $('.price').text('16.00')
            $('input[name="currency_code"]').val('USD')
            $('input[name="li_0_price"]').val('16.00')
            ...
            $('.price').text('18.00')
            $('input[name="currency_code"]').val('USD')
            $('input[name="li_0_price"]').val('18.00')
        } else {
            $('.curr').html('USD')
            $('.price').text('18.00')
            $('input[name="currency_code"]').val('USD')
