...
if (isset($_POST['time'])) {
    if ($_POST['time'] < 0) {
        ...
        try {
            header('location: repeatsentence3.php?x=' . $_POST['time'] . '&y=' . $_POST['ftime']);       
            exit();
        } catch (PDOException $e) {
            echo '<br> error updating database: ' . $e->getMessage();
            exit();
...
<head>
    ...
    <title>PTE Practice Test - Repeat Sentence Question 2</title>
...
//    }
        ...
        function upload(blob){    
            ...
            xhr('myphpuploaders/repeatsentence2uploader.php', formData, function (fName) {
