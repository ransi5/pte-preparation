...
$content = $question = $optiona = $optionb = $optionc = $optiond = $optione = '';
try {
...
//        $s->execute();
        if ($_POST['time'] < 0) {
                ...
                header('location: samplereorderparagraph.php?x=' . $_POST['time'] . '&y=' . $_POST['ftime']);       
                exit();        
        }
    } catch (PDOException $e) {
...
<head>
    ...
    <title>PTE Practice Test - Reading, MCQ Muliple Answer Question 1</title>
