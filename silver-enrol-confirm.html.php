...
<div class="container">
    <div class="bbox">
        ...
        <div class="confbox">
            <h4>PTE preparation Silver Course - <span class="curr spchar"></span> <span class="price spchar"></span></h4>
            <p>You get</p>
            <p>30 days access - timed practice questions in test like conditions - 2 scored practice test 
            - answer key with model answers - in-depth practice test result & analysis - Micro Analytics- complete access to 
            PTE strategy & tips on our blog - option to upgrade to Gold and Diamond courses</p>
        ...
        <div class="buttons">
            <form action="https://www.2checkout.com/checkout/purchase" method="post">
                ...
                <input type='hidden' name='li_0_name' value='Silver Course' >
                <input type='hidden' name='li_0__description' value='30 days access - timed practice questions in test like conditions - 2 scored practice test 
            - answer key with model answers - in-depth practice test result & analysis - Micro Analytics- complete access to 
            PTE strategy & tips on our blog - option to upgrade to Gold and Diamond courses' >
                <input type="hidden" name="li_0_price" value="" />
                <input type="hidden" name="currency_code" value="" />
                <input type="hidden" name="x_receipt_link_url" value="https://pte-preparation.com/orderconfirmation.html.php?x=2" />
...
$(document).ready(function() {
    $.getJSON("https://freegeoip.net/json/", function (data) {
        ...
        if (country == "India") {
            ...
            $('input[name="li_0_price"]').val('860.00')
        } else if (country == "Bangladesh") {
            $('.curr').html('USD')
            $('.price').text('17.00')
            $('input[name="currency_code"]').val('USD')
            $('input[name="li_0_price"]').val('17.00')
