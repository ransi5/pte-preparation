...
if (isset($_POST['time'])) {
    if ($_POST['time'] < 0) {
        ...
        try {
            header('location: sampleretelllecture.php?x=' . $_POST['time'] . '&y=' . $_POST['ftime']);       
            exit();
        } catch (PDOException $e) {
            echo '<br> error updating database: ' . $e->getMessage();
            exit();
...
<head>
    ...
    <title>PTE Practice Test - Describe Image Question 1</title>
...
<body>
    ...
    <div class="container">
		...
		<img id="myimage" src="" class="img-rounded img-thumbnail img-responsive" style="max-height:550px;max-width:650px;min-height:450px;min-width:450px;">
...
//
//            xhr('myphpuploaders/imagespeakuploader.php', formData, function (fName) {
