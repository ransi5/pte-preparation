...
if (isset($_POST['time'])) {
    if ($_POST['time'] < 0) {
        ...
        try {
            header('location: sampleimagespeak.php?x=' . $_POST['time'] . '&y=' . $_POST['ftime']);       
            exit();
        } catch (PDOException $e) {
            echo '<br> error updating database: ' . $e->getMessage();
            exit();
...
$(document).ready(function() {
  ...
  <script>
	...
	var source ="serveruploads/questions/repeatsentence/8PP10.mp3";   // enter you audio source here
