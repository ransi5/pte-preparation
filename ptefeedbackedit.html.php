...
<head>
    ...
    <title>PTE Preparation - Coaching Appointment Editor</title>
        ...
        <div class="gill">
            ...
            <div class="container">
                <form method="post" action="">
                    <p>ID: <input type="number" name="id" value="<?php echo $feeid; ?>" readonly></p>
                    <p>Student ID: <?php echo $studid; ?></p>
                    <p>Appointment Focus: <textarea rows="5" cols="80" name="focus"><?php echo $focus; ?></textarea></p>
                    <p>Date: <input type="date" name="date" value="<?php echo $date; ?>"></p>
                    <p>Time: <input type="time" name="time" value="<?php echo $time; ?>"></p>
