...
if (isset($_POST['time'])) {
    if ($_POST['time'] < 0) {
        ...
        try {
            header('location: retelllecture3.php?x=' . $_POST['time'] . '&y=' . $_POST['ftime']);       
            exit();
        } catch (PDOException $e) {
            echo '<br> error updating database: ' . $e->getMessage();
            exit();
...
<head>
    ...
    <title>PTE Practice Test - Re-tell Lecture Question 2</title>
...
//    }
        ...
        function upload(blob){    
            ...
            xhr('myphpuploaders/retelllecture2uploader.php', formData, function (fName) {
