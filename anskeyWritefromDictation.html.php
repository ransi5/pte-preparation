...
try {
    ...
    $s->execute();
    $result = $s->fetchAll();
    $sql1 = "select * from lwwritefromdictationanswers where lwwstudid = :studid and lwwtestid = :testid limit $limit, $perpage";
    $s = $conn->prepare($sql1);
...
<head>
    ...
    <title>PTE Preparation - Write from Dictation Answer Key</title>
...
<div class="container-fluid sidenav">
    <div class="row">
        ...
        <div class="col-md-8 mid">
            <h2>Question type: Write from Dictation</h2>
            <ul class="pagination">
            ...
            <div class="qbox">
                <h3>Item <?php echo $row['lwwqno'];?></h3>
                <audio controls>
                    <source src="serveruploads/questions/lwwritefromdictation/<?php echo $row['lwwfile']; ?>" type="audio/mpeg">
                </audio>
                <p><?php echo $row['lwwqanswer'];?></p>                
                <?php foreach ($answer as $how) {?>
                <div class="youranswer">
                    <h3>Your Answer</h3>
                    <p class="text"><?php echo $how['lwwanswer'];?></p>
                </div>
                <?php } ?>
                <div class="modanswer">
                    <h3>Model Answer</h3>
                    <p class="text"><?php echo $row['lwwqanswer'];?></p>
                </div>
            </div>
            <?php } ?>
